       ...
       <div class="card-body">
          ...
          <div class="col-sm">
            <div class="row my-2">
                ...
                <div class="col-sm-10">: <?php echo $tgs['nm_guru']; ?></div>
            </div>
            <hr>
...
<div class="modal fade" id="EditNilai<?php echo $i->kd_kelas; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        ...
        <form action="<?php echo base_url('page/editNilaiTGS') ?>" method="post" >
        <div class="modal-body">
            ...
            <!-- <div class="form-group row">
                <label for="nil_uas" class="form-control-label col-lg-3">Alamat</label>
                
                <div class="col-lg-9"> -->
                    <input type="hidden" name="nil_uas" class="form-control" placeholder="Alamat..." required value="<?php echo $i->nil_uas; ?>">
                <!-- </div>
            </div> -->

            <div class="form-group row">
                <label for="nil_tgs" class="form-control-label col-lg-3">Nilai Tugas</label>
                
                <div class="col-lg-9">
                    <input type="text" name="nil_tgs" class="form-control" placeholder="Nilai Tugas..." required value="<?php echo $i->nil_tgs; ?>">
                </div>
            </div>
