       ...
       <div class="card-body">
          ...
          <div class="col-sm">
            <div class="row my-2">
                ...
                <div class="col-sm-10">: <?php echo $uts['nm_guru']; ?></div>
            </div>
            <hr>
...
<div class="modal fade" id="EditNilai<?php echo $i->kd_kelas; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        ...
        <form action="<?php echo base_url('page/editNilai') ?>" method="post" >
        <div class="modal-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-9">
                    <input type="text" name="nil_uts" class="form-control" placeholder="Masukkan nilai UTS..." value="<?php echo $i->nil_uts; ?>">
                </div>
            </div>
