          ...
          <div class="row">
            <div class="col-sm">
               ...
               <div class="card-body">
                ...
                <p class="mt-2">
                  <a class="mt-2 ml-1"  href="<?php echo base_url('page') ?>"><i class="fas fa-backward"></i> Kembali</a>
                  <a class="mt-2 ml-1"  href="" data-toggle="modal" data-target="#EditDataPribadiSiswa<?php echo $tb_siswa['nis']; ?>"><i class="fas fa-edit"></i> Edit Data</a>
                </p>
              </div>
            </div>
          </div>
...
<div class="modal fade" id="EditDataPribadiSiswa<?php echo $i->nis; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        ...
        <form action="<?php echo base_url('page/editDataPribadiSiswa'); ?>" method="post" >
        <div class="modal-body">

          <input type="hidden" name="nis" class="form-control" required value="<?php echo $i->nis; ?>">
          ...
          <div class="row">
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-9">
                    <input type="text" name="nm_wali" class="form-control" placeholder="Nama Wali..." required value="<?php echo $i->nm_wali; ?>">
                </div>
            </div>
